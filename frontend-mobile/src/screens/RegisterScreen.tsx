...
export default function RegisterScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#fff8f6]">
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', paddingHorizontal: 24, paddingVertical: 24 }}>
        <View className="items-center mb-8">
          ...
          <Text className="text-gray-500">Join Recilink today</Text>
        </View>
        ...
        >
          <GoogleIcon />
          <Text className="ml-3 text-gray-700 font-bold text-base">Sign up with Google</Text>
        </TouchableOpacity>

        <View className="flex-row justify-center mt-2">
          <Text className="text-gray-600">Already have an account? </Text>
          <TouchableOpacity onPress={() => navigation.navigate('Login')}>
            <Text className="text-[#FE6B36] font-bold">Sign In</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
